...
@Repository
@Transactional
public class HibernateBank implements IBank {
...
//	}
	...
	@Override
	public Collection<Account> getAccount() throws DataAccessException {
		return null;
	}

	@Override
	public Account loadAccount(int id) throws DataAccessException {
		return null;
	}

	@Override
	public void storeAccount(Account account) throws DataAccessException {
